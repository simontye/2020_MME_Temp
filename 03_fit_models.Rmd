...
# First generalized model for water temperature (removed population for now because of NAs, otherwise same as Till)
...
# Second generalized model for water temperature (removed population for now because of NAs, otherwise same as Till)
...
###   closing unused connection 8 (<-localhost:11642)
### 3: In .Internal(gc(verbose, reset, full)) :
###   closing unused connection 7 (<-localhost:11642)
### 4: In .Internal(gc(verbose, reset, full)) :
###   closing unused connection 6 (<-localhost:11642)
### 5: In .Internal(gc(verbose, reset, full)) :
###   closing unused connection 5 (<-localhost:11642)
### 6: In .Internal(gc(verbose, reset, full)) :
###   closing unused connection 4 (<-localhost:11642)
### 7: In .Internal(gc(verbose, reset, full)) :
###   closing unused connection 3 (<-localhost:11642)
...
### Error in lmer(w1_re, data = training, family = binomial, REML = FALSE,  : 
...
### Error in lmer(a1_re, data = training, family = binomial, REML = FALSE,  : 
###   unused argument (family = binomial)
