...
# Compare with testing data
#pred <- predict(ridge_w1_logloss, s = 9.14e-06, newx = XXX)
...
# The final values used for the model were alpha = 0 and lambda = 1.5e-05.
...
ridge_a1_logloss_ds <- glmnet(x = ridge_a1_logloss_ds_vars, y = ridge_a1_logloss_ds_resp,
                              family = "binomial", alpha = 0, lambda = 1.5e-05)
...
# Compare with testing data
#pred <- predict(ridge_a1_logloss_ds, s = 3.2e-06, newx = XXX)

# Save model
write_rds(ridge_a1_logloss_ds, "assessment/ridge_a1_logloss_ds.rds")

# Remove objects
rm(ridge_a1_logloss_ds_train,
   ridge_a1_logloss_ds_resp,
   ridge_a1_logloss_ds_vars)
```
...
# Compare with testing data
#pred <- predict(ridge_w1_logloss_ds, s = 1.5e-05, newx = XXX)

# Save model
write_rds(ridge_w1_logloss_ds, "assessment/ridge_w1_logloss_ds.rds")

# Remove objects
rm(ridge_w1_logloss_ds_train,
   ridge_w1_logloss_ds_resp,
   ridge_w1_logloss_ds_vars)
```
