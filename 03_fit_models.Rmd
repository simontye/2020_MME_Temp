...
a2e <- summerkill ~ long + lat + season + population +
...
a2s <- summerkill ~ long + lat + season + population +
  min_air + mean_air + max_air + 
  min_air_z + mean_air_z + max_air_z +
  air_quad_temp + state
...
a2se <- summerkill ~ long + lat + season + population +
  min_air + mean_air + max_air + 
  min_air_z + mean_air_z + max_air_z +
...
# Complex generalized model for air temperature (ecoregion)
a2e.state <- summerkill ~ long + lat + season + population +
  min_air + mean_air + max_air + 
  min_air_z + mean_air_z + max_air_z +
  air_quad_temp + l3_code
```
...
# Simple generalized model for water temperatures
...
# Simple generalized model for air temperature
logistic_a1e.mn <- glm(a1e.state, training.mn, family = "binomial")

# Stepwise model comparisons by AIC
logistic_a1e.mn <- step(logistic_a1s.mn)
...
# Simple generalized model for air temperature
logistic_a1e.wi <- glm(a1e.state, training.wi, family = "binomial")

# Stepwise model comparisons by AIC
logistic_a1e.wi <- step(logistic_a1s.wi)
