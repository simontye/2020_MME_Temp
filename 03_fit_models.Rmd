...
These are for the simple models by state. For now, ecoregion (l3_code) is included.
...
These models are for the complex models by state. For now, ecoregion (l3_code) is included.
...
# Simple generalized model for water temperature
logistic_w1e.mi <- glm(w1e.state, training.mi, family = "binomial")

# Stepwise model comparisons by AIC
logistic_w1e.mi <- step(logistic_w1e.mi)

# Simple generalized model for air temperature
logistic_a1s.mi <- glm(a1e.state, training.mi, family = "binomial")

# Stepwise model comparisons by AIC
logistic_a1s.mi <- step(logistic_a1s.mi)

# Complex generalized model for water temperature
logistic_w2e.mi <- glm(w2e.state, training.mi, family = "binomial")

# Stepwise model comparisons by AIC
logistic_w2e.mi <- step(logistic_w2e.mi)

# Complex generalized model for air temperature
logistic_a2e.mi <- glm(a2e.state, training.mi, family = "binomial")

# Stepwise model comparisons by AIC
logistic_a2e.mi <- step(logistic_a2e.mi)

### WI models

# Simple generalized model for water temperature
logistic_w1e.wi <- glm(w1e.state, training.wi, fawily = "binomial")

# Stepwise model comparisons by AIC
logistic_w1e.wi <- step(logistic_w1e.wi)

# Simple generalized model for air temperature
logistic_a1s.wi <- glm(a1e.state, training.wi, fawily = "binomial")

# Stepwise model comparisons by AIC
logistic_a1s.wi <- step(logistic_a1s.wi)

# Complex generalized model for water temperature
logistic_w2e.wi <- glm(w2e.state, training.wi, fawily = "binomial")

# Stepwise model comparisons by AIC
logistic_w2e.wi <- step(logistic_w2e.wi)

# Complex generalized model for air temperature
logistic_a2e.wi <- glm(a2e.state, training.wi, fawily = "binomial")

# Stepwise model comparisons by AIC
logistic_a2e.wi <- step(logistic_a2e.wi)

# Save models
write_rds(logistic_w1e.mi, "assessment/logistic_w1e_mi.rds")
write_rds(logistic_a1e.mi, "assessment/logistic_a1e_mi.rds")
write_rds(logistic_w2e.mi, "assessment/logistic_w2e_mi.rds")
write_rds(logistic_a2e.mi, "assessment/logistic_a2e_mi.rds")
...
# Remove models
rm(logistic_w1e.mi, logistic_a1e.mi,
   logistic_w2e.mi, logistic_a2e.mi,
