...
ggplot(data = states, mapping = aes(x = long, y = lat, group = group)) + 
  ...
  scale_fill_manual(values = c("#2c7bb6", "#abd9e9", "#d7191c", "#fdae61", "#ffffbf")) +
  theme_nothing() #+
  #north(states) +
...
plot.summer.raw <- ggplot() +
  geom_boxplot(boxplot.raw.summer,
               ...
               outlier.color = "black", outlier.alpha = 0.02, outlier.size = 0.75) +
  labs(x = NULL) +
  scale_fill_manual(values = c("#d7191c", "#abd9e9", "lightgray")) +
...
plot.winter.raw <- ggplot() +
  geom_boxplot(boxplot.raw.winter,
               ...
               outlier.color = "black", outlier.alpha = 0.02, outlier.size = 0.75) +
  labs(x = NULL) +
  scale_fill_manual(values = c("#fdae61", "lightgray")) +
...
# Save figure
pdf("figures/fig_3_time.pdf", width = 8, height = 6) 
...
# Save figure
pdf("figures/fig_3_temp.pdf", width = 6, height = 3) 
...
```{r, plot, echo = `FALSE`}
# Save figure
pdf("figures/fig_4_map.pdf", width = 20, height = 7) 

# Combine maps
ggarrange(plot.air.1, plot.air.2, plot.air.3, plot.air,
          plot.water.1, plot.water.2, plot.water.3, plot.water,
          labels = c("Air (2003-2013)", "Air (2041-2059)", "Air (2081-2099)", "Difference",
                     "Water (2003-2013)", "Water (2041-2059)", "Water (2081-2099)", "Difference"),
          ncol = 4, nrow = 2,
          legend = NULL)
...
### Fig 5. Critical thermal maximum (CTmax)
...
# Save figure
pdf("figures/fig_5_thermal.pdf", width = 10, height = 10) 
...
ggarrange(plot.diff.1, plot.diff.2, plot.diff.3,
          labels = c("Difference (2003-2013)", "Difference (2041-2059)", "Difference (2081-2099)"),
          ncol = 3, nrow = 1,
          legend = NULL)
...
# Combine maps
ggarrange(plot.diff.1,plot.diff.2, plot.diff.3, plot.diff.time.all,
          labels = c("Early 21st Century", "Mid-21st Century", "Late 21st Century",
                     "Total Difference"),
          ncol = 4, nrow = 1,
          legend = NULL)
...
# Combine maps
ggarrange(plot.air.1, plot.air.2, plot.air.3, plot.diff.air,
          plot.water.1, plot.water.2, plot.water.3, plot.diff.water,
          labels = c("Air (2003-2013)", "Air (2041-2059)", "Air (2081-2099)", "Difference",
                     "Water (2003-2013)", "Water (2041-2059)", "Water (2081-2099)", "Difference"),
          ncol = 4, nrow = 2,
          legend = NULL)
